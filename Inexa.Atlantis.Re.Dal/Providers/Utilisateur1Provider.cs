...
{
  public class Utilisateur1Provider
  {

      #region Singleton
      
      private static Utilisateur1Provider _instance;

      public static Utilisateur1Provider Instance
      {
          get { return _instance ?? (_instance = new Utilisateur1Provider()); }
      }

      #endregion

      private readonly IRepository<Utilisateur1> _repositoryUtilisateur1;
     
      private Utilisateur1Provider()
      {
          _repositoryUtilisateur1 = new Repository<Utilisateur1>();
      }

      private Utilisateur1Provider(IRepository<Utilisateur1> repository)
      {    
          _repositoryUtilisateur1 = repository;
      }
      ...
      public BusinessResponse<Utilisateur1Dto> GetUtilisateur1ById(object id)
      {
          ...
          try
          {
              var item = _repositoryUtilisateur1[id];
      ...
      public BusinessResponse<Utilisateur1Dto> GetUtilisateur1sByCriteria(BusinessRequest<Utilisateur1Dto> request)
      {
          ...
          try
          {
              ...
              if (request.ItemsToSearch == null) 
                request.ItemsToSearch = new List<Utilisateur1Dto>();                                                    
 
              var exps = new List<Expression<Func<Utilisateur1, bool>>>();                    
              ...
              Expression<Func<Utilisateur1, bool>> exp = null;                  
              foreach (var expi in exps)
              {
                  ...
                  Expression<Func<Utilisateur1, object>> orderByExp = GenerateOrderByExpression(request.ItemToSearch);
                  ...
                  int totalRecord;
                  IEnumerable<Utilisateur1> items = _repositoryUtilisateur1.GetMany(exp, request.Index, request.Size, out totalRecord, orderByExp, request.SortOrder);
  
                  response.Count = totalRecord;
                  items = items as IList<Utilisateur1> ?? items.ToList();
      ...
      /// <param name="request">La requete contenant les criteres de recherche</param>
      /// <returns></returns>
      public BusinessResponse<decimal> GetSumUtilisateur1sByCriteria(BusinessRequest<Utilisateur1Dto> request)
      {
          ...
          try
          {
              ...
              foreach (var expi in exps)
              {
                  ...
                  var sum = _repositoryUtilisateur1.GetSum(exp, sumExp);
      ...
      /// <returns></returns>
        ...
        var response = new BusinessResponse<Utilisateur1Dto>();
              ...
              try
              {
                  foreach (var item in request.ItemsToSave.TakeWhile(BusinessRequest<Utilisateur1Dto>.ValidateRequiredProperties))
                  {
                     var itemToSave = item.ToEntity();
                     Utilisateur1 itemSaved = null;
                     ...
                     if (itemToSave.IdUtilisateur == 0)  
                     {  
                        itemToSave.DateCreation = Utilities.CurrentDate;   
                        itemToSave.CreatedBy = request.IdCurrentUser;   

                        itemToSave.IsDeleted = false;
                        itemSaved = _repositoryUtilisateur1.Add(itemToSave);
                     }
                     else //dans le cas d'une modification
                     {
                         itemSaved = _repositoryUtilisateur1.Update(itemToSave, p => p.IdUtilisateur == itemToSave.IdUtilisateur);
                     }
      ...
      private static Expression<Func<Utilisateur1, bool>> GenerateCriteria(Utilisateur1Dto itemToSearch) 
      {
          Expression<Func<Utilisateur1, bool>> exprinit = obj => true;
          Expression<Func<Utilisateur1, bool>> expi = exprinit;
      ...
      private static Expression<Func<Utilisateur1, object>> GenerateOrderByExpression(Utilisateur1Dto itemToSearch)
      {
          Expression<Func<Utilisateur1, object>> exp = null;
      ...
      /// <param name="itemToSearch">objet DTO contenant les champs de recherche</param>
      /// <returns>Expression lambda</returns>
      private static Expression<Func<Utilisateur1, decimal?>> GenerateSumExpression(Utilisateur1Dto itemToSearch)
      {
          Expression<Func<Utilisateur1, decimal?>> exp = null;
      ...
      /// <param name="itemToSearch">objet DTO contenant les champs de recherche</param>
      /// <returns>Expression lambda</returns>
      private Utilisateur1Dto GenerateSum(Expression<Func<Utilisateur1, bool>> criteria, Utilisateur1Dto itemToSearch, Utilisateur1Dto itemToReturn)
      {
          if (itemToSearch.InfoSearchTimeSession.IsSumField)
            itemToReturn.InfoSearchTimeSession.Sum = _repositoryUtilisateur1.GetSum(criteria, o => o.TimeSession.Value);     
               
            if (itemToSearch.InfoSearchCreatedBy.IsSumField)
            itemToReturn.InfoSearchCreatedBy.Sum = _repositoryUtilisateur1.GetSum(criteria, o => o.CreatedBy);
                                        
            if (itemToSearch.InfoSearchModifiedBy.IsSumField)
            itemToReturn.InfoSearchModifiedBy.Sum = _repositoryUtilisateur1.GetSum(criteria, o => o.ModifiedBy.Value);     
               
            if (itemToSearch.InfoSearchTentativeConnexion.IsSumField)
            itemToReturn.InfoSearchTentativeConnexion.Sum = _repositoryUtilisateur1.GetSum(criteria, o => o.TentativeConnexion.Value);     
